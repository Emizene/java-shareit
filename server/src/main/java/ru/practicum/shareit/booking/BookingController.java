...
public class BookingController {
    ...
    public ResponseEntity<BookingResponseDto> updateBooking(@RequestHeader(SharedHeaders.USER_ID_HEADER) Long userId,
    ...
    @GetMapping
    public ResponseEntity<List<BookingResponseDto>> getAllUserBookings(@RequestHeader(SharedHeaders.USER_ID_HEADER) Long userId,
                                                                       @RequestParam(name = "state", required = false, defaultValue = "ALL") String state) {
        return bookingService.getAllUserBookings(userId, state);
    }

    @GetMapping("/owner")
    public ResponseEntity<List<BookingResponseDto>> getAllOwnerBookings(@RequestHeader(SharedHeaders.USER_ID_HEADER) Long userId,
                                                                        @RequestParam(name = "state", required = false, defaultValue = "ALL") String state) {
